        ...
        <div class="col-sm-4 col-sm-offset-5">         
            <form class="" action="" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
				  ...
				  <a href="registerForm.php" class="btn btn-success">Registrarse</a>
				  <input type="submit" name="reponer" class="btn btn-danger" value="Reponer Fragancias">
				  
				  <?php

					if(isset($_POST['reponer'])){
						$query = query("UPDATE fragancias SET stock = 10 WHERE stock < 10");
						confirm($query);
					}
